...
#make env
env = super_pelican_env.SuperPelicanEnv(driving_agent='pelican', config_file_path='/home/davidr/plark/plark_ai_public/Components/plark-game/plark_game/game_config/30x30/balanced.json')
#make model
