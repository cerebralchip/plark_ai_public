...
from gym_plark.envs import plark_env, plark_env_non_image_state, super_pelican_env
import helper
import logging
import os
...
def createNonImageEnv():
	return super_pelican_env.SuperPelicanEnv(driving_agent='pelican', config_file_path='/home/alexr/dev/plark/plark_ai_public/Components/plark-game/plark_game/game_config/30x30/panther_easy.json')

def createImageEnv():
	return plark_env.PlarkEnv(driving_agent='pelican', config_file_path='/home/alexr/dev/plark/plark_ai_public/Components/plark-game/plark_game/game_config/30x30/panther_easy.json')
...
if __name__ == '__main__':
	...
	parser.add_argument("--max-seconds", type=float, default=300, help="Maximum time to train each algorithm for")
	parser.add_argument("--testing-interval", type=int, default=1000, help="Number of training steps between evaluations")
	parser.add_argument("--base-path", type=str, default="/home/alexr/dev/plark/plark_ai_public/data/agents/models", help="Directory to store trained models & logs in")
