...
from gym_plark.envs import plark_env, plark_env_top_left, super_pelican_env
...
mean_reward, n_steps = evaluate_policy(model, env, n_eval_episodes=1, deterministic=False,
